<?php
    ...
    $sql = "SELECT * FROM user_emergency_contact";
        ...
        <table class="user mx-auto table">
            <thead>
                <tr>
                    ...
                    <th scope="col">EmC First Name</th>
                    <th scope="col">EmC Last Name</th>
                    <th scope="col">EmC Address</th>
                    <th scope="col">EmC Phone</th>
                    <th></th>
                    <th></th>
                </tr>
            </thead>
            ...
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>    
                <tr>
                    ...
                    <td>
                        <a href="../include/admin/delete.contact.php?contactid=<?php echo $row["contact_Id"]?>" class="btn btn-danger"><i class="bi bi-trash3-fill"></i></a>
                    </td>
                    <td><a href="./update/emergency.contact.php?contactid=<?php echo $row["contact_Id"]?>" class="btn btn-warning"><i class="bi bi-pencil-fill"></i></a></td>
                </tr>
            <?php } ?>
            </tbody>
        </table>
