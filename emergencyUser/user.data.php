<?php
if (isset($_POST['eMCsubmit'])) {
    require_once '../include/dbh.inc.php';
    $sql = "SELECT * FROM user_info WHERE user_unique = ?;";
    $stmt = mysqli_stmt_init($conn);
    if (!mysqli_stmt_prepare($stmt, $sql)) {
      header("location: ../priority/emergencyUser/index.em.php?error=stmtfailed");
      exit();
    }
    $userUnique = $_POST["userUnique"];


    mysqli_stmt_bind_param($stmt, "s", $userUnique);
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light mb-3">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="index.em.php">Home</a>
            </li>
          </ul>
